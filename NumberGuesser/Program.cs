...
namespace NumberGuesser
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ///asking for a random number range
                ...
                {
                    Console.WriteLine("You got it right? Wow!");
                }
                else if (playerGuess < computerNumber)
                {
                    Console.WriteLine("You guessed too low. Bummer...");
                }
                else if (playerGuess > computerNumber)
                {
                    Console.WriteLine("You overshot the mark! Overachiever...");
                }
